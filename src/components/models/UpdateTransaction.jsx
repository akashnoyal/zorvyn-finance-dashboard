...
export default function UpdateTransaction({ setTransactions, setShowModal, transaction }) {
    ...
    const handleUpdate = async () => {
        ...
        const updated = await mockApi.update(transaction.id, {
            ...form,
    ...
    return (
        <motion.div
            ...
            <motion.div
                ...
                <h2 className="text-[var(--text-primary)] font-semibold text-lg">Update Transaction</h2>
